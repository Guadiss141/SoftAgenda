...
<head>
    ...
    <style>
        ...
        .table th { background: #fdfbf7; color: #5c4a3d; font-weight: 600; white-space: nowrap; }
...
<body>
    <div class="container">
                    ...
                    <tbody>
                        <?php while($row = $usuarios->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td><?= htmlspecialchars($row['Rol_Descripcion'] ?? 'Paciente') ?></td>
                                <td>
                                    <div class="action-links">
                                        <a href="editar_usuario.php?id=<?= $row['id_Usuario'] ?>" class="btn btn-primary btn-small">Editar</a>
                                        <a href="#" class="btn btn-danger btn-small" onclick="return confirmarEliminacion(event, '../Controllers/UsuarioController.php?action=eliminar&id=<?= $row['id_Usuario'] ?>')">Eliminar</a>
                                    </div>
                                </td>
                            </tr>
                        <?php endwhile; ?>
        ...
        <div class="button-group" style="justify-content: center;">
            <a href="registro_terapeuta.php" class="btn btn-success">Registrar Nuevo Terapeuta</a>
    ...
    <div id="modal-confirmacion" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(60, 50, 40, 0.6); justify-content: center; align-items: center; z-index: 2000; backdrop-filter: blur(3px);">
        <div style="background: #fdfbf7; padding: 40px; border-radius: 20px; width: 90%; max-width: 400px; text-align: center; box-shadow: 0 20px 40px rgba(0,0,0,0.2);">
            <h3 style="color: #5c4a3d; margin-top: 0; font-weight: 400;">¿Eliminar Usuario?</h3>
            <p style="color: #666; margin-bottom: 25px;">¿Estás seguro de que deseas eliminar permanentemente a este usuario? Esta acción no se puede deshacer.</p>
            <div style="display: flex; gap: 10px; justify-content: center;">
                <a id="btn-confirmar-si" href="#" class="btn btn-danger" style="margin: 0;">Sí, Eliminar</a>
