...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($resultado && $resultado->num_rows > 0) {
        ...
        if (password_verify($contraseña, $usuario['Usuario_Contraseña'])) {
            ...
            // 1. Intentar buscar en la tabla Empleado
            ...
            if ($res_emp->num_rows > 0) {
                // ES UN EMPLEADO (Admin, Terapeuta o Recepcionista)
                ...
                // 2. Si no es empleado, buscamos en la tabla Paciente
                ...
                if ($res_pac->num_rows > 0) {
                    ...
                    // Guardar datos personales del paciente en sesión
